...
import {Grid, LinearProgress, ListItem, ListItemButton, ListItemIcon, ListItemText} from "@mui/material";
import React, {useEffect, useState} from "react";
//import {List} from "@mui/icons-material";
import CancelIcon from '@mui/icons-material/Cancel';
import CheckIcon from '@mui/icons-material/Check';
import {
    acceptApplicant, getApplicants, rejectApplicant
} from "../../utils/Projects";
            ...
            applicants.map((item, index) => {
                ...
                return (
                    <ListItem disablePadding key={index}>
                        ...
                        <ListItemButton onClick={() => {onReject(item.id)}}>
                            <ListItemIcon>
                                <CancelIcon/>
                            </ListItemIcon>
                        </ListItemButton>
                        <ListItemButton onClick={() => {onAccept(item.id)}}>
                            <ListItemIcon>
                                <CheckIcon/>
                            </ListItemIcon>
                        </ListItemButton>
